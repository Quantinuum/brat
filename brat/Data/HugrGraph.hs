...
module Data.HugrGraph(NodeId,
                      HugrGraph(root,HugrGraph), -- do NOT export contents, keep abstract
                      new,
                      freshNode,
                      setFirstChildren,
...
------------------------------------ Querying ----------------------------------
--------------------------------------------------------------------------------
getFirstChildren :: Ord n => HugrGraph n -> n -> Maybe [n]
getFirstChildren hg node = M.lookup node (first_children hg)
